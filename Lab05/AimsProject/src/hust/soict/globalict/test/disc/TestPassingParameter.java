...
public class TestPassingParameter {
    ...
    public static void swap1(DigitalVideoDisc o1, DigitalVideoDisc o2) throws LimitExceededException {
    ...
    public static void changeTitle(DigitalVideoDisc dvd, String title) throws LimitExceededException {
